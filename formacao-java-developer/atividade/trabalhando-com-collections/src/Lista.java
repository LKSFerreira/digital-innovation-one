...
public class Lista {
    public static void main(String[] args) throws Exception {
        ...
        // ArrayList deve ser utulizado quando muitas operações de pesquisa forem necessárias
        // LinkedList deve ser utilizado quando muitas operações de inserção e remoção forem necessárias

        // ArrayList utiliza por abstração um array para armazenar os elementos
        // LinkedList utiliza por abstração uma lista duplamente encadeada para armazenar os elementos
